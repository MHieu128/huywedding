  ...
  return (
    <main className="flex flex-col w-full h-screen">
      <div id="content" className="flex flex-col md:flex-row w-full h-full overflow-y-auto">
        ...
        <div className="lg:w-2/5 h-full flex flex-col items-center justify-center p-8 bg-gray-50 overflow-y-auto relative z-10">
          <section className="w-full max-w-2xl">
            <div className="relative bg-white h-screen rounded-lg shadow-md mb-6 animate-slideIn">
              <Image
              ...
              />
              <div className="relative flex flex-col items-center z-20 p-6 bg-white bg-opacity-90 rounded-lg">
                <p className="text-lg font-semibold mb-2">
                  Saturday, November 2, 2024
                </p>
                <p className="text-lg text-gray-600 mb-2">Singapore</p>
